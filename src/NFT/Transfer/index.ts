...
export const createTransferCompressedNftInstruction = async (to: PublicKey, assetId: PublicKey) => {
    //////////////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////////////
    ...
    if (!asset.compression.compressed) {
        throw Error(`The asset ${asset.id} is NOT a compressed NFT!`);
    }
